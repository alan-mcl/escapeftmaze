...
public abstract class AbstractRoomGenerator extends AbstractGenerator
{
	...
	/**
	 * @param roomType determines how the room is carved. Room type is chosen at
	 *                 random during room generating. Note that you can add a
	 *                 single room type multiple times to make it more likely for
	 *                 the type to be chosen.
	 */
	 ...
	 *                 single room type multiple times to make it more likely for
	 *                 the type to be chosen.
	 * @param times    this is how many times the room will be added to the list.
	 *                 The bigger this value, the more likely this room time gets
	 *                 rolled.
	 */
	...
	/**
	 * @param roomTypes determine how the rooms are carved. Room type is chosen
	 *                  at random during room generating. Note that you can add a
	 *                  single room type multiple times to make it more likely
	 *                  for the type to be chosen.
	 */
	...
	protected void carveRoom(final Grid grid, final Room room, final float value)
	{
		...
		{ // No types specified: carving whole room:
		...
		else
		{
			...
			while (!type.isValid(room))
			{
				...
				{ // No valid types found for the room:
					room.fill(grid, value);
					return;
				}
	...
	/**
	 * @return random odd room size within {@link #minRoomSize} and {@link
	 * #maxRoomSize} range.
	 */
	 ...
	 * @return random odd room size within {@link #minRoomSize} and {@link
	 * #maxRoomSize} range, respecting {@link #tolerance}
	 */
	...
	/**
	 * @param minRoomSize minimum room's width and height. Some algorithms might
	 *                    require this value to be odd - even values might be
	...
	/**
	 * @param maxRoomSize maximum room's width and height. Some algorithms might
	 *                    require this value to be odd - even values might be
	 *                    normalized or ignored.
	 */
	...
	/**
	 * @param tolerance maximum difference between room's width and height. The
	 *                  bigger the tolerance, the more rectangular the rooms can
	 *                  be.
	 */
	...
	/**
	 * @return maximum amount of generated rooms. If 0 or negative, there is no
	 * limit.
	 */
	...
	/**
	 * @param maxRoomsAmount maximum amount of generated rooms. While achieving a
	 *                       certain amount of rooms is not always possible (due
	 *                       to collisions or simply the map being too small to
	 *                       store chosen amount), you can limit the maximum
	 *                       amount of rooms that will be generated. If set to
	 *                       negative or zero (the default value), there is no
	 *                       limit.
	 */
	...
	/**
	 * Basic rectangle class. Contains position and size of a single room.
	 * Provides simple, common math operations.
	 *
	 * @author MJ
	 */
