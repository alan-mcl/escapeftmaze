package mclachlan.dungeongen.noise4j.map.generator.util;
 ...
 *
 * <p>
 * When used in LibGDX applications, it is a good idea to replace {@link Random}
 * and {@link Calculator} instances with values and methods of {@code MathUtils}
 * class, which provides both more efficient random implementation and sin/cos
 * look-up tables. See {@link #setRandom(Random)} and {@link
 * #setCalculator(Calculator)}. This should be done before using any generators
 * - see example below:
 *
 * <blockquote>
 *
...
{
	/**
	 * Length of generated random seeds with {@link #rollSeed()}. Depending on
	 * the algorithm, this value might vary - in which case {@link
	 * #rollSeed(int)} method should be used instead.
	 */
	...
	/**
	 * @return {@link Random} instance shared by the generators. Not thread-safe,
	 * unless modified with {@link #setRandom(Random)}.
	 */
	...
	/**
	 * @param random will be available through {@link #getRandom()} instance.
	 *               This method allows to provide a thread-safe, secure or
	 *               specialized random instance. In LibGDX applications, you'd
	 *               generally want to use MathUtils.random instance.
	 */
	...
	/**
	 * @return static instance of immutable, thread-safe {@link Calculator},
	 * providing common math functions.
	 */
	...
	/**
	 * @param calculator instance of immutable, thread-safe {@link Calculator},
	 *                   providing common math functions.
	 */
	...
	/**
	 * @return a random probable prime with {@link #DEFAULT_SEED_BIT_LENGTH}
	 * bits.
	...
	/**
	 * GWT-compatible collection shuffling method. Use only for lists with quick
	 * random access; use {@link java.util.Collections#shuffle(List)} if not
	 * targeting GWT.
	 *
	...
	/**
	 * Allows to calculate common generators' functions. By implementing this
	 * interface, you can replace these common functions with a more efficient
	 * solutions - for example, a look-up table. In LibGDX applications,
	 * MathUtils class can be used for these operations.
	 *
	 * <p>
