...
public class StatPackPanel extends JPanel
{
	...
	static
	{
		...
		plantProperties.setModifier(Stats.Modifiers.IMMUNE_TO_POISON, 1);
		plantProperties.setModifier(Stats.Modifiers.IMMUNE_TO_BLIND, 1);
		plantProperties.setModifier(Stats.Modifiers.IMMUNE_TO_DISEASE, 1);
		plantProperties.setModifier(Stats.Modifiers.IMMUNE_TO_INSANE, 1);
		plantProperties.setModifier(Stats.Modifiers.IMMUNE_TO_NAUSEA, 1);
		plantProperties.setModifier(Stats.Modifiers.RESIST_FIRE, -5);
		statPacks.put("Plant properties", plantProperties);

		StatModifier gnome = new StatModifier();
		gnome.setModifier(Stats.Modifiers.THIEVING, 1);
		gnome.setModifier(Stats.Modifiers.SNEAKING, 1);
		gnome.setModifier(Stats.Modifiers.POWER, 1);
		gnome.setModifier(Stats.Modifiers.DUNGEONEER, 1);
		gnome.setModifier(Stats.Modifiers.POSTURE, 1);
		gnome.setModifier(Stats.Modifiers.RHYME, 1);
		gnome.setModifier(Stats.Modifiers.ALCHEMIC, 1);
		gnome.setModifier(Stats.Modifiers.HERBAL, 1);
		statPacks.put("Gnome properties", gnome);

		StatModifier gnoll = new StatModifier();
		gnoll.setModifier(Stats.Modifiers.BRAWN, 1);
		gnoll.setModifier(Stats.Modifiers.SNEAKING, 1);
		gnoll.setModifier(Stats.Modifiers.WILDERNESS_LORE, 1);
		gnoll.setModifier(Stats.Modifiers.SURVIVAL, 1);
		statPacks.put("Gnoll properties", gnoll);

		StatModifier leonal = new StatModifier();
		leonal.setModifier(Stats.Modifiers.BRAWN, 1);
		leonal.setModifier(Stats.Modifiers.SKILL, 1);
		leonal.setModifier(Stats.Modifiers.ATTACK, 1);
		leonal.setModifier(Stats.Modifiers.CHIVALRY, 1);
		leonal.setModifier(Stats.Modifiers.CHANT, 1);
		leonal.setModifier(Stats.Modifiers.POSTURE, 1);
		leonal.setModifier(Stats.Modifiers.VS_AMBUSH, 1);
		statPacks.put("Leonal properties", leonal);

		StatModifier undead = new StatModifier();
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_POISON, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_DISEASE, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_INSANE, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_NAUSEA, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_DISEASE, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_IRRITATE, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_POSSESSION, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_PSYCHIC, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_SLEEP, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_PARALYSE, 1);
		undead.setModifier(Stats.Modifiers.IMMUNE_TO_FEAR, 1);
		statPacks.put("Undead properties", undead);

		StatModifier golem = new StatModifier();
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_POISON, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_PSYCHIC, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_DISEASE, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_FEAR, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_INSANE, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_IRRITATE, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_NAUSEA, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_PARALYSE, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_POSSESSION, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_SLEEP, 1);
		golem.setModifier(Stats.Modifiers.IMMUNE_TO_STONE, 1);
