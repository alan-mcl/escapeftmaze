 ...
 *
 */
public class SingleTileScriptComponent extends JButton implements ActionListener
{
	...
	/*-------------------------------------------------------------------------*/
	public SingleTileScriptComponent(int dirtyFlag, Zone zone)
	{
		this(null, dirtyFlag, null, zone);
	}

	/*-------------------------------------------------------------------------*/
	public SingleTileScriptComponent(TileScript tileScript, int dirtyFlag, Zone zone)
	{
		this(tileScript, dirtyFlag, null, zone);
	}

	/*-------------------------------------------------------------------------*/
	public SingleTileScriptComponent(
