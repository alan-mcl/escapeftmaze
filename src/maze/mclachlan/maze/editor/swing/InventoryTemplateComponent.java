...
public class InventoryTemplateComponent extends JPanel implements ActionListener
{
	...
	{
		for (ItemTypeComponent comp : d.comps)
		{
	...
	private class QuickFillDialog extends JDialog implements ActionListener
	{
		...
		private QuickFillDialog()
		{
			...
			this.add(new JLabel("Enter integers or Dice in each field..."), BorderLayout.NORTH);
			this.add(mid, BorderLayout.CENTER);
			this.add(buttons, BorderLayout.SOUTH);

			pack();
			setLocationRelativeTo(InventoryTemplateComponent.this);
			setVisible(true);
		}
