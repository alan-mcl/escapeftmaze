/**
 * SOURCE: http://forum.codecall.net/topic/49665-java-random-name-generator/
 *
	...
	public static void main(String[] args) throws Exception
	{
		if (args.length != 3)
		{
			System.out.println("USAGE: [input file] " +
				"[names to generate (int)] [nr syllables (dice)]");
			System.out.println("e.g. <mainclass> ./input.txt 20 1d3+1");
			System.exit(1);
		}
