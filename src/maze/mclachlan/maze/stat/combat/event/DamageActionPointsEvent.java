 ...
 *
 */
public class DamageActionPointsEvent extends MazeEvent
{
	...
	/*-------------------------------------------------------------------------*/
	public DamageActionPointsEvent(
	...
	public List<MazeEvent> resolve()
	{
		...
		CurMax actionPoints = defender.getActionPoints();
		actionPoints.decCurrent(damage);
		if (actionPoints.getCurrent() < 0)
		{
			actionPoints.setCurrent(0);
		}
	...
	{
		return getDamage()+" action points lost";
	}
}
