 ...
 *
 */
public class ConditionRemovalEvent extends MazeEvent
{
	ConditionBearer target;
	Condition condition;

	/*-------------------------------------------------------------------------*/
	public ConditionRemovalEvent(
		ConditionBearer target,
		Condition condition)
	{
	...
	{
		return getTarget().getDisplayName()+" is no longer "+getCondition().getAdjective();
	}
}
