...
/**
 * Asynchronous thread to play audio data in parallel of the rendered images.
 * Send an empty array or interrupt to close this thread. Will start and stop
...
public class AudioThread extends Thread
{
	...
	/**
	 * If audio playback is delayed, setting this flag to true will terminate the
	 * playback loop.
	 */
	...
	/*-------------------------------------------------------------------------*/
	/**
	 * Creates the audio output stream. The returned output stream is opened but
	 * not started.
	 *
	 * @return the created audio output stream or null if no audio support is
	 *         available.
	 */
	...
	/*-------------------------------------------------------------------------*/
	/**
	 * Calculates the moving average of the given sample data using the defined
	 * window.
	 *
	...
	/*-------------------------------------------------------------------------*/
	/**
	 * Send an audio sample to the audio player. Can be called from any thread.
	 *
