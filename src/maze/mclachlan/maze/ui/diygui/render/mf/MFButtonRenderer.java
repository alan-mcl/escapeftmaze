		...
		DIYButton button, Component comp)
	{
		...
		if (button.isEnabled())
		{
			switch (button.getState())
			{
				case DEFAULT ->
				{
					borderTop = Database.getInstance().getImage("ui/mf/button/border_top");
					borderBottom = Database.getInstance().getImage("ui/mf/button/border_bottom");
					borderLeft = Database.getInstance().getImage("ui/mf/button/border_left");
					borderRight = Database.getInstance().getImage("ui/mf/button/border_right");
					cornerTopLeft = Database.getInstance().getImage("ui/mf/button/corner_top_left");
					cornerTopRight = Database.getInstance().getImage("ui/mf/button/corner_top_right");
				...
				case HOVER ->
				{
					borderTop = Database.getInstance().getImage("ui/mf/button/border_top_hover");
					borderBottom = Database.getInstance().getImage("ui/mf/button/border_bottom_hover");
					borderLeft = Database.getInstance().getImage("ui/mf/button/border_left_hover");
					borderRight = Database.getInstance().getImage("ui/mf/button/border_right_hover");
					cornerTopLeft = Database.getInstance().getImage("ui/mf/button/corner_top_left_hover");
					cornerTopRight = Database.getInstance().getImage("ui/mf/button/corner_top_right_hover");
				...
				case DEPRESSED ->
				{
					borderTop = Database.getInstance().getImage("ui/mf/button/border_top_depressed");
					borderBottom = Database.getInstance().getImage("ui/mf/button/border_bottom_depressed");
					borderLeft = Database.getInstance().getImage("ui/mf/button/border_left_depressed");
					borderRight = Database.getInstance().getImage("ui/mf/button/border_right_depressed");
					cornerTopLeft = Database.getInstance().getImage("ui/mf/button/corner_top_left_depressed");
					cornerTopRight = Database.getInstance().getImage("ui/mf/button/corner_top_right_depressed");
		...
		{
			// disabled
			borderTop = Database.getInstance().getImage("ui/mf/button/border_top_disabled");
			borderBottom = Database.getInstance().getImage("ui/mf/button/border_bottom_disabled");
			borderLeft = Database.getInstance().getImage("ui/mf/button/border_left_disabled");
			borderRight = Database.getInstance().getImage("ui/mf/button/border_right_disabled");
			cornerTopLeft = Database.getInstance().getImage("ui/mf/button/corner_top_left_disabled");
			cornerTopRight = Database.getInstance().getImage("ui/mf/button/corner_top_right_disabled");
