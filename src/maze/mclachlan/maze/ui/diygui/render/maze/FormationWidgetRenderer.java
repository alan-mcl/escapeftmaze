...
import mclachlan.maze.ui.diygui.FormationWidget;

public class FormationWidgetRenderer extends Renderer
{
	/*-------------------------------------------------------------------------*/
	@Override
	public void render(Graphics2D g, int x, int y, int width, int height, Widget w)
	{
		FormationWidget widget = (FormationWidget)w;

		DIYLabel selected = widget.getSelected();
		if (selected != null)
		{
