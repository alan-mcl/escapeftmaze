...
It is a gloomy dungeon with a bunch of low level monsters in it. There are three possible exits, one guarded by a golem (easiest to beat for a stealth focussed party), one guarded by spell casting spiders (easiest to beat for a combat focussed party) and one guarded by insect swarms (easiest to beat for a magic focussed party). They deposit the party in different places along the north-south road in Ichiba domain.

Foes: bats, spiders, roaches

Notes

* An illegible “Second Realm” signpost greets the party. A thief can spot secret "thieves guild claims this area" signs on it.
* The west-most room contains a secret passage that leads to a chest of potions and Resurrection Powders
* A dark area contains glowing fungus, and hides chest with some equipment
* A northern room contains a secret passage which leads to a chest
* A feral familiar abandoned by a deceased adventurer leads a pack of bats and spiders. It guards a chest.
* A series of rooms with encounters leads to a chest containing gold and some non-magical weapons and armour
...
Stenelaus the Doorwarden stands guard before the gate of Danaos Castle.
