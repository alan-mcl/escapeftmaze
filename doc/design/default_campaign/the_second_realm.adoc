...
* Beyond Emmons, the left path leads to a gloomy partly flooded series of passages. _One pool contains hidden items_. Beyond this is the chamber of the insect swarms.
