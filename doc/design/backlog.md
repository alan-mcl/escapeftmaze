...
| P2-28 | feature | Temple of Wasud campaign (`temple`) | Sparse child of default; rogue-like delve + balance lab. Spec: [temple_campaign.md](temple_campaign.md) §15. Phases 0–3 done; Phase 4 **4a.1 dressing done** (room encounters, wall chests, foe roster, per-floor environment); Noise4j topology + alternate gens remain. | XL | in-progress |
