...
public class InMemoryLoader extends Loader
{
	...
	@Override public List<PartyCamp> loadPartyCamps(String saveGameName)
	{
		List<PartyCamp> camps = partyCamps.get(saveGameName);
		return camps != null ? camps : new ArrayList<>();
	}
