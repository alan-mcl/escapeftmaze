...
public class Gurney extends NpcScript
{
	...
	public List<MazeEvent> preAppearance()
	{
		...
		{
			return getList(
				new FlavourTextEvent("A sturdy dwarf slouches at the table, tankard close at hand, eyes fixed somewhere out the window.", FlavourTextEvent.Alignment.TOP),
				new FlavourTextEvent("As you approach he rises to great you...", FlavourTextEvent.Alignment.TOP));
		}
		else
		{
			return null;
